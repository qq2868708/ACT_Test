...
void USkillManager::BeginPlay()
{
	...
	{
		GetOwner()->InputComponent->BindAction("Q",IE_Pressed,this,&USkillManager::CastSkill1);
		GetOwner()->InputComponent->BindAction("W",IE_Pressed,this,&USkillManager::CastSkill2);
		GetOwner()->InputComponent->BindAction("E",IE_Pressed,this,&USkillManager::CastSkill3);
	}
...
void USkillManager::BindSkill2(USkillComponent* Skill)
{
	BindSkill(Skill,Skill2);
}

void USkillManager::CastSkill2()
{
	CastSkill(Skill2);
}

void USkillManager::BindSkill3(USkillComponent* Skill)
{
	BindSkill(Skill,Skill3);
}

void USkillManager::CastSkill3()
{
	CastSkill(Skill3);
}
